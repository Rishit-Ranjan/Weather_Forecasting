...
# Use fallback if env var is missing or is the placeholder text
OPENWEATHER_API_KEY = env_key if env_key and env_key != "your_api_key_here" else "98978729593a6890d12daaf6e3492d66"
